---
name: hoja7-analista-ia
description: Analiza y calcula tarifas de la Hoja 7 (Table 7) con salida estructurada y trazable. Usar cuando el usuario pida validar rangos de peso, calcular precios por servicio C/D/E/F/G/H, detectar inconsistencias de datos, normalizar unidades g/kg/gr o generar reporte ejecutivo de hallazgos.
---
...
Estandarizar el analisis de la Hoja 7 para producir resultados claros, trazables y accionables.

## Flujo de trabajo

1. Entender la solicitud y definir alcance exacto de la Hoja 7.
...
- Para integraciones API, priorizar salida estructurada del wrapper `backend/app/skills/skill7/tools/calcular_hoja7_json.sh`.
...
- Usar `../../contracts/hoja7_result.schema.json` como referencia de contrato JSON.
