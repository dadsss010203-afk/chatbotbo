#!/usr/bin/env python3
"""Motor de calculo para Hoja 5 (Table 5) sin dependencias externas."""
...
SHEET_NAME = "Table 5"
DEFAULT_XLSX = Path(__file__).resolve().parent.parent / "data" / "Tarifario_Hoja5.xlsx"

NS = {"a": "http://schemas.openxmlformats.org/spreadsheetml/2006/main"}
REL_NS = {"r": "http://schemas.openxmlformats.org/package/2006/relationships"}

COLUMNAS = {'C': ['Local'], 'D': ['Nacional'], 'E': ['Depto.'], 'F': ['Prov.'], 'G': ['Destino Especial / Trinidad - Cobija'], 'H': ['Destino Especial / Riberalta - Guayaramerín']}
...
def main():
    parser = argparse.ArgumentParser(description="Calcula tarifa Hoja 5 (Table 5)")
    parser.add_argument(
        "--xlsx",
        default=str(DEFAULT_XLSX),
        help="Ruta absoluta o relativa al archivo xlsx (por defecto usa backend/app/skills/skill5/data/Tarifario_Hoja5.xlsx)",
    )
