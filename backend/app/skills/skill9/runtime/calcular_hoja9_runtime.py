#!/usr/bin/env python3
"""Motor de calculo para Hoja 9 (Table 9) sin dependencias externas."""
...
SHEET_NAME = "Table 9"
DEFAULT_XLSX = Path(__file__).resolve().parent.parent / "data" / "Tarifario_Hoja9.xlsx"

NS = {"a": "http://schemas.openxmlformats.org/spreadsheetml/2006/main"}
REL_NS = {"r": "http://schemas.openxmlformats.org/package/2006/relationships"}

COLUMNAS = {'C': ['Local'], 'D': ['Nacional'], 'E': ['Prov. Dentro Depto.'], 'F': ['Prov. Depto. Prov.']}
...
def main():
    parser = argparse.ArgumentParser(description="Calcula tarifa Hoja 9 (Table 9)")
    parser.add_argument(
        "--xlsx",
        default=str(DEFAULT_XLSX),
        help="Ruta absoluta o relativa al archivo xlsx (por defecto usa backend/app/skills/skill9/data/Tarifario_Hoja9.xlsx)",
    )
    parser.add_argument("--peso", required=True, help="Peso con unidad, ej. 800g o 0.8kg")
    parser.add_argument("--columna", help="Columna C/D/E/F (ej. C)")
