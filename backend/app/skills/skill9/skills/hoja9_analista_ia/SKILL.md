---
name: hoja9-analista-ia
description: Analiza y calcula tarifas de la Hoja 9 (Table 9) con salida estructurada y trazable. Usar cuando el usuario pida validar rangos de peso, calcular precios por servicio C/D/E/F, detectar inconsistencias de datos, normalizar unidades g/kg/gr o generar reporte ejecutivo de hallazgos.
---
...
Estandarizar el analisis de la Hoja 9 para producir resultados claros, trazables y accionables.

## Flujo de trabajo

1. Entender la solicitud y definir alcance exacto de la Hoja 9.
...
- Para integraciones API, priorizar salida estructurada del wrapper `backend/app/skills/skill9/tools/calcular_hoja9_json.sh`.
...
- Usar `../../contracts/hoja9_result.schema.json` como referencia de contrato JSON.
