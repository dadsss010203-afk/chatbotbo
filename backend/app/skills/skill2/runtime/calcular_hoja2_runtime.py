#!/usr/bin/env python3
"""
Motor de calculo para Hoja 2 (Table 2) sin dependencias externas.
"""
...
SHEET_NAME = "Table 2"
DEFAULT_XLSX = Path(__file__).resolve().parent.parent / "data" / "Tarifario_Hoja2.xlsx"

NS = {"a": "http://schemas.openxmlformats.org/spreadsheetml/2006/main"}
REL_NS = {"r": "http://schemas.openxmlformats.org/package/2006/relationships"}

COLUMNAS = {
    "C": ["América Del Sur", "Destinos A"],
    "D": ["América Central y El Caribe", "Destinos B"],
    "E": ["América Del Norte", "Destinos C"],
    "F": ["Europa y Medio Oriente", "Destinos D"],
    "G": ["África, Asia y Oceanía", "Destinos E"],
}
...
def main():
    parser = argparse.ArgumentParser(description="Calcula tarifa Hoja 2 (EMS Internacional)")
    parser.add_argument(
        "--xlsx",
        default=str(DEFAULT_XLSX),
        help="Ruta absoluta o relativa al archivo xlsx (por defecto usa backend/app/skills/skill2/data/Tarifario_Hoja2.xlsx)",
    )
    parser.add_argument("--peso", required=True, help="Peso con unidad, ej. 800g o 0.8kg")
    parser.add_argument("--columna", help="Columna C-G (ej. C)")
    parser.add_argument("--servicio", help="Nombre del servicio (ej. 'América Del Sur' o 'Destinos A')")
