#!/usr/bin/env python3
"""Motor de calculo para Hoja 8 (Table 8) sin dependencias externas."""
...
SHEET_NAME = "Table 8"
DEFAULT_XLSX = Path(__file__).resolve().parent.parent / "data" / "Tarifario_Hoja8.xlsx"
...
def main():
    parser = argparse.ArgumentParser(description="Calcula tarifa Hoja 8 (Table 8)")
    parser.add_argument(
        "--xlsx",
        default=str(DEFAULT_XLSX),
        help="Ruta absoluta o relativa al archivo xlsx (por defecto usa backend/app/skills/skill8/data/Tarifario_Hoja8.xlsx)",
    )
