---
name: hoja11-analista-ia
description: Analiza y calcula tarifas de la Hoja 11 (Table 11) con salida estructurada y trazable. Usar cuando el usuario pida validar rangos de peso, calcular precios por servicio C/D, detectar inconsistencias de datos, normalizar unidades g/kg/gr o generar reporte ejecutivo de hallazgos.
---
...
Estandarizar el analisis de la Hoja 11 para producir resultados claros, trazables y accionables.

## Flujo de trabajo

1. Entender la solicitud y definir alcance exacto de la Hoja 11.
...
- Para integraciones API, priorizar salida estructurada del wrapper `backend/app/skills/skill11/tools/calcular_hoja11_json.sh`.
...
- Usar `../../contracts/hoja11_result.schema.json` como referencia de contrato JSON.
