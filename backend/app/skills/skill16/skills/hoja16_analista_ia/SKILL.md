---
name: hoja16-analista-ia
description: Analiza y calcula tarifas de la Hoja 16 (Table 16) con salida estructurada y trazable. Usar cuando el usuario pida validar rangos de peso, calcular precios por servicio B/C/D/E/F/G/H, detectar inconsistencias de datos, normalizar unidades g/kg/gr o generar reporte ejecutivo de hallazgos.
---
...
Estandarizar el analisis de la Hoja 16 para producir resultados claros, trazables y accionables.

## Flujo de trabajo

1. Entender la solicitud y definir alcance exacto de la Hoja 16.
...
- Para integraciones API, priorizar salida estructurada del wrapper `backend/app/skills/skill16/tools/calcular_hoja16_json.sh`.
...
- Usar `../../contracts/hoja16_result.schema.json` como referencia de contrato JSON.
