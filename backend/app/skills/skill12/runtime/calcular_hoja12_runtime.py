#!/usr/bin/env python3
"""Motor de calculo para Hoja 12 (Table 12) sin dependencias externas."""
...
SHEET_NAME = "Table 12"
DEFAULT_XLSX = Path(__file__).resolve().parent.parent / "data" / "Tarifario_Hoja12.xlsx"
...
def main():
    parser = argparse.ArgumentParser(description="Calcula tarifa Hoja 12 (Table 12)")
    parser.add_argument(
        "--xlsx",
        default=str(DEFAULT_XLSX),
        help="Ruta absoluta o relativa al archivo xlsx (por defecto usa backend/app/skills/skill12/data/Tarifario_Hoja12.xlsx)",
    )
