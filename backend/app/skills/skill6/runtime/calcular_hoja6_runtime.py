#!/usr/bin/env python3
"""Motor de calculo para Hoja 6 (Table 6) sin dependencias externas."""
...
SHEET_NAME = "Table 6"
DEFAULT_XLSX = Path(__file__).resolve().parent.parent / "data" / "Tarifario_Hoja6.xlsx"
...
def main():
    parser = argparse.ArgumentParser(description="Calcula tarifa Hoja 6 (Table 6)")
    parser.add_argument(
        "--xlsx",
        default=str(DEFAULT_XLSX),
        help="Ruta absoluta o relativa al archivo xlsx (por defecto usa backend/app/skills/skill6/data/Tarifario_Hoja6.xlsx)",
    )
