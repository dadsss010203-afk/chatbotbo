#!/usr/bin/env python3
"""Motor de calculo para Hoja 15 (Table 15) sin dependencias externas."""
...
SHEET_NAME = "Table 15"
DEFAULT_XLSX = Path(__file__).resolve().parent.parent / "data" / "Tarifario_Hoja15.xlsx"

NS = {"a": "http://schemas.openxmlformats.org/spreadsheetml/2006/main"}
REL_NS = {"r": "http://schemas.openxmlformats.org/package/2006/relationships"}

COLUMNAS = {
    "B": ["Sud América / Tarifa 1"],
    "C": ["Centro América Y Florida EE.UU. / Tarifa 2"],
    "D": ["Resto De EE.UU. / Tarifa 3"],
    "E": ["Caribe / Tarifa 4"],
    "F": ["Europa / Tarifa 5"],
    "G": ["Medio Oriente / Tarifa 6"],
    "H": ["África Y Asia / Tarifa 7"],
}
...
def main():
    parser = argparse.ArgumentParser(description="Calcula tarifa Hoja 15 (Table 15)")
    parser.add_argument(
        "--xlsx",
        default=str(DEFAULT_XLSX),
        help="Ruta absoluta o relativa al archivo xlsx (por defecto usa backend/app/skills/skill15/data/Tarifario_Hoja15.xlsx)",
    )
    ...
    parser.add_argument("--servicio", help="Nombre del servicio (ej. 'Sud América / Tarifa 1')")
