#!/usr/bin/env python3
"""Motor de calculo para Hoja 10 (Table 10) sin dependencias externas."""
...
SHEET_NAME = "Table 10"
DEFAULT_XLSX = Path(__file__).resolve().parent.parent / "data" / "Tarifario_Hoja10.xlsx"

NS = {"a": "http://schemas.openxmlformats.org/spreadsheetml/2006/main"}
REL_NS = {"r": "http://schemas.openxmlformats.org/package/2006/relationships"}

COLUMNAS = {'C': ['América del Sur / Destino A'], 'D': ['América Central y El Caribe / Destino B'], 'E': ['América del Norte / Destino C'], 'F': ['Europa y Medio Oriente / Destino D'], 'G': ['África, Asia y Oceanía / Destino E']}
...
def main():
    parser = argparse.ArgumentParser(description="Calcula tarifa Hoja 10 (Table 10)")
    parser.add_argument(
        "--xlsx",
        default=str(DEFAULT_XLSX),
        help="Ruta absoluta o relativa al archivo xlsx (por defecto usa backend/app/skills/skill10/data/Tarifario_Hoja10.xlsx)",
    )
    parser.add_argument("--peso", required=True, help="Peso con unidad, ej. 800g o 0.8kg")
    parser.add_argument("--columna", help="Columna C/D/E/F/G (ej. C)")
    parser.add_argument("--servicio", help="Nombre del servicio (ej. 'América del Sur / Destino A')")
