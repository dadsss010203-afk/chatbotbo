#!/usr/bin/env python3
"""Motor de calculo para Hoja 4 (Table 4) sin dependencias externas."""
...
SHEET_NAME = "Table 4"
DEFAULT_XLSX = Path(__file__).resolve().parent.parent / "data" / "Tarifario_Hoja4.xlsx"
...
def main():
    parser = argparse.ArgumentParser(description="Calcula tarifa Hoja 4 (Table 4)")
    parser.add_argument(
        "--xlsx",
        default=str(DEFAULT_XLSX),
        help="Ruta absoluta o relativa al archivo xlsx (por defecto usa backend/app/skills/skill4/data/Tarifario_Hoja4.xlsx)",
    )
    ...
    parser.add_argument("--servicio", help="Nombre del servicio (ej. 'América Del Sur / Destinos A')")
