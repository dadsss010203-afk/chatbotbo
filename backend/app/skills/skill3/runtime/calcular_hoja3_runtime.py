#!/usr/bin/env python3
"""Motor de calculo para Hoja 3 (Table 3) sin dependencias externas."""
...
SHEET_NAME = "Table 3"
DEFAULT_XLSX = Path(__file__).resolve().parent.parent / "data" / "Tarifario_Hoja3.xlsx"
...
def main():
    parser = argparse.ArgumentParser(description="Calcula tarifa Hoja 3 (Table 3)")
    parser.add_argument(
        "--xlsx",
        default=str(DEFAULT_XLSX),
        help="Ruta absoluta o relativa al archivo xlsx (por defecto usa backend/app/skills/skill3/data/Tarifario_Hoja3.xlsx)",
    )
    parser.add_argument("--peso", required=True, help="Peso con unidad, ej. 800g o 0.8kg")
    parser.add_argument("--columna", help="Columna C-F (ej. C)")
    parser.add_argument("--servicio", help="Nombre del servicio (ej. 'Ciudades Capitales')")
