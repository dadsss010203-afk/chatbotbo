---
name: hoja1-analista-ia
description: Analiza y calcula tarifas de la Hoja 1 (Table 1) del tarifario EMS con salida estructurada y trazable. Usar cuando el usuario pida validar rangos de peso, calcular precios por servicio C-J, detectar inconsistencias de datos, normalizar unidades g/kg, resolver huecos entre rangos o generar reporte ejecutivo de hallazgos.
---
...
Estandarizar el analisis de la Hoja 1 para producir resultados claros, trazables y accionables, evitando respuestas ambiguas.

## Flujo de trabajo

1. Entender la solicitud y definir alcance exacto de la Hoja 1.
2. Levantar estructura de datos: filas 8-29, rangos A-B y columnas tarifarias C-J.
...
- Para integraciones API, priorizar salida estructurada del wrapper `backend/app/skills/skill1/tools/calcular_hoja1_json.sh`.
...
- Usar `../../contracts/hoja1_result.schema.json` como referencia de contrato para respuestas JSON.
